...
public class SimOutput {
	...
	public void outputFile(boolean Done, String oppnetFile,
			PrintWriter oppnetFileWriter, String measureName,
			double measureValue, String name, int id) {

		try {
			oppnetFileWriter = new PrintWriter(new BufferedWriter(
					new FileWriter(oppnetFile, true)));
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public void outputFile1(int num, boolean Done, String oppnetFile,
			PrintWriter oppnetFileWriter, String measureName,
			double measureValue, String name, int id) {
