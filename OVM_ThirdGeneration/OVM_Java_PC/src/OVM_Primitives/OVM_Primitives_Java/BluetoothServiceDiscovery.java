...
Writer wr = null;
wr = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(remoteDevice + ".txt"), "utf-8"));

if(connectionURL==null){


	wr.write("Device does not support Object Push.");

    System.out.println("Device does not support Object Push.");
}
else{
    wr.write("Device supports Object Push.");
